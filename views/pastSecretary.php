<?php
    ...
    $total_pages_sql = "SELECT COUNT(*)FROM `pastemployee` WHERE `Position` ='Secretary/Treasurer'";
   ...
   /* This query is selecting all data from table 'member' which is order by ID(report-id) in descending order */
    $queryPast ="SELECT * FROM `pastemployee` WHERE `Position` ='Secretary/Treasurer' ORDER BY `ID` DESC LIMIT $offset, $no_of_records_per_page";
...
?>
    ...
    <div class="container">
        <div class="container content">
            <div class="ff8300 officer"><h2>MAFS Past Officer</h2> <h3>Secretary/Treasurer</h3></div> 
                <?php 
