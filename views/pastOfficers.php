<?php
    ...
    $total_pages_sql = "SELECT COUNT(*)FROM `pastemployee` WHERE `Position` ='President'";
   ...
   /* This query is selecting all data from table 'member' which is order by ID(report-id) in descending order */
    $queryPast ="SELECT * FROM `pastemployee` WHERE `Position` ='President' ORDER BY `ID` DESC LIMIT $offset, $no_of_records_per_page";
...
?>
    ...
    <div class="container">
        <div class="container content">
            <div class="ff8300 officer"><h2>MAFS Past Officer</h2> <h3>President</h3></div> 
                <?php 
            ...
            <div class="row mediaBody">
                ...
                <div class="col-md-3" style="padding-top:1em;">
                    ...
                    <!-- Displaying Position, Name, University and Year which is stored in associate array -->
                            <h4 class="media-heading" style="padding-top:1em;"><?php echo($pastEmployee[$i]['Position']);?></h4>
                            <div class="media">                                    
