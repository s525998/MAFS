<?php
    ...
    include_once("processUniversity.php");
...
<?php
    ...
    $total_pages_sql = "SELECT COUNT(*)FROM `university`";
   ...
   $queryPast ="SELECT * FROM `university` ORDER BY UniName ASC LIMIT $offset, $no_of_records_per_page";
...
<?php
    ...
    <?php 
        ...
        echo $_SESSION['uniList']; 
        unset ($_SESSION['uniList']); ?>
</div>
<?php endif?>
...
<div class= "row">
        ...
        <div class="col-sm-9 col-md-10"> 
            ...
            <thead>
                <th height="50" >University Name </th>
                <th> Faculty Link </th>
                <th> Is Member </th>
                <th> Action </th>
            </thead>
            ...
            <td height="100" width="180"><?php echo $row['UniName']; ?></td>
            <td  height="100" ><?php echo $row['FacultyLink']; ?></td>
            <td  height="100"><?php if ($row['isMember'] == 1){
                echo "Yes";
            } else{
                echo "No";
            } ?></td>
            ...
            <a href="addUniversity.php?editId=<?php echo $row['id'];?>" class="btn btn-info" id="btn"> Edit </a>

            <!-- Passing event id, date and eventName to ProcessEvent.php using GET method for delete option -->
            <a href="processUniversity.php?idEmp=<?php echo $row['id'];?>&Name=<?php echo $row['UniName'];?>" class="btn btn-danger" id ="btn"> Delete </a>
            </td>
            </tr>
