...
<?php
    ...
    $total_pages_sql = "SELECT COUNT(*)FROM `voter`";
   ...
   $queryPast ="SELECT * FROM `voter` ORDER BY UniName ASC LIMIT $offset, $no_of_records_per_page";
...
<?php
    ...
    <?php 
        ...
        echo $_SESSION['voterList']; 
        unset ($_SESSION['voterList']); ?>
</div>
<?php endif?>
...
<div class= "row">
        ...
        <div class="col-sm-9 col-md-10"> 
            ...
            <td height="100" width="200"><?php echo $row['UniName']; ?></td>
            <td  height="100" ><?php echo $row['vName1']; ?></td>
            <td  height="100" ><?php echo $row['vName2']; ?></td>
            ...
            <a href="addVoter.php?editId=<?php echo $row['id'];?>" class="btn btn-info" id="btn"> Edit </a>

            <!-- Passing event id, date and eventName to ProcessEvent.php using GET method for delete option -->
            <a href="processVoter.php?idEmp=<?php echo $row['id'];?>&Name=<?php echo $row['UniName'];?>" class="btn btn-danger" id="btn"> Delete </a>
            </td>
            </tr>
