...
<div class="login-form">
    <div class="main-div">
        ...
        <form method="POST" action="processUniversity.php">
        ...
        <input type="hidden" name="id" value="<?php echo $id; ?>">
            ...
            <div class="form-group">
                <label class="b891"> Faculty Link </label>
            ...
            <div class="form-group">
                <label class="b891"> Member </label>
                <br>
                <label>Yes
                    <input type="radio" name="isMember" value ='true'/>
                </label> 
                <label>No
                    <input type="radio" name="isMember" value ='false'/>
                </label>
            </div>
            <br>
            <br>
